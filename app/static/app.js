...
const state = {
  ...
  version: "2.4.1", updateJobId: "", qualityIssues: [], openSourceReferences: [],
...
function applyTheme() {
  ...
  document.title = `${settings.team_name || "燕翔车队"} · 经费管理系统 V${state.version || "2.4.1"}`;
}
...
async function loadBootstrap() {
  ...
  state.version = data.version || "2.4.1";
